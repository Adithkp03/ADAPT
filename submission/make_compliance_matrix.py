...
ROWS = [
    ("Public artifact opens without authentication", "release checklist T1-T2",
     "submission/artifact_url.txt (deploy)", "TODO-DEPLOY"),
    ...
    ("Public repository", "git remote", "submission/repository_url.txt (deploy)", "TODO-DEPLOY"),
    ...
    ("Concept summary (500-950 words)",
     "concept_summary.md (722 words prose)", "repo root -> PDF at deploy", "DONE"),
    ("Blog PDF", "submission/blog.pdf", "submission/", "TODO-DEPLOY"),
    ...
    ("Learner study (8-15 participants) — PENDING (pilot n=1 only)",
     "evaluation/learning_evaluation_report.md", "evaluation/", "PARTIAL"),
