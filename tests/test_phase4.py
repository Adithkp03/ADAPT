...
def test_d41_d42_technical_dossiers():
    bdh = (ROOT / "research" / "bdh" / "bdh_technical_dossier.md").read_text()
...
def test_d43_concept_mapping():
    t = (ROOT / "research" / "bdh" / "concept_mapping.md").read_text()
...
def test_d47_comparison_study():
    ...
    md = (ROOT / "research" / "bdh" / "frontier_comparison.md").read_text()
...
def test_d410_audit_and_banned_wording():
    assert (ROOT / "docs" / "bdh_integrity_audit.md").exists()
